...
\node<2> [anchor=north west,inner sep=0pt] (snip) at (-1,4) {\scalebox{9}{\snipdocunsigned}};
\node<2> [anchor=north,inner sep=0pt] (snipdesc) at ($(snip.north)+(0,-.5)$) {\scalebox{6}{\shortdoc}};
