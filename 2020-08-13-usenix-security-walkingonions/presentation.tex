...
\frametitle{Tor Security Model: Security over Scalability}
  \begin{itemize}
    \item Consensus size grows quadratically relative to the number of relays!
    \item[]~
    \item Goal: Same protections against eptistemic and path-routing attacks
      with less overhead to clients.
  \end{itemize}
\end{frame}
...
\begin{center}
  ...
  \begin{minipage}[t] {0.45\linewidth}
    ...
    \begin{tikzpicture}
    \scalebox{0.17} {
      \includegraphics{relay-plot.png}
    }
    \end{tikzpicture}
  \end{minipage}
  \hspace{0.8cm}
  \begin{minipage}[t] {0.45\linewidth}
    ...
    \begin{tikzpicture}
    \scalebox{0.17} {
      \includegraphics{relay-plot-89.png}
    }
    \end{tikzpicture}
  \end{minipage}
\end{center}
...
\begin{center}
  ...
  \begin{minipage}[t] {0.45\linewidth}
    ...
    \begin{tikzpicture}
    \scalebox{0.17} {
      \includegraphics{client-plot.png}
    }
    \end{tikzpicture}
  \end{minipage}
  \hspace{0.8cm}
  \begin{minipage}[t] {0.45\linewidth}
    ...
    \begin{tikzpicture}
    \scalebox{0.17} {
      \includegraphics{client-plot-89.png}
    }
    \end{tikzpicture}
  \end{minipage}
\end{center}
