...
\frametitle{Our Contributions: Walking Onions}
  \begin{itemize}
    ...
    \item[]~
    \item \textbf{Same Threat Model.} Maintains Tor's existing security model
      in one variant, with a slight loss of forward secrecy in the other.
    \item[]~
...
\begin{tikzpicture}
  ...
  \begin{pgfonlayer}{background}
    \node [anchor=north,inner sep=0pt] (cons) at (-1, 1)  {\longconsensus};
