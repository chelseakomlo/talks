...
\begin{frame}
  ...
  \begin{itemize}
    \item<1-> The Digital Signature Algorithm (DSA) was designed in part to avoid the patent by Schnorr while providing a signature scheme that reduced to discrete logarithm assumptions. 
    \item[]
  \end{itemize}
\end{frame}
